...
filt.to_csv('top_30_recs.csv', index=False)
...
plt.bar(all_recommendations_df['Recommended Song'], all_recommendations_df['Similarity'], color='blue')
plt.xlabel('Recommended Song')
plt.ylabel('Similarity Score')
plt.title('Top Recommended Songs and Their Similarity Scores')
